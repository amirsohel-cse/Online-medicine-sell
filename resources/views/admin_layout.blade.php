        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{URL:: to('/all_manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
                    <li><a href="{{URL:: to('/add_manufacture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add brand</span></a></li>
                    <li>
