...
class ManufactureController extends Controller
{
    ...
    {
        $this->AdminAuthCheck();
        DB::table('tb1_manufacture')-> where('manufacture_id',$manufacture_id)->delete();
        Session::put('message','Manufacture Deleted succesfully !! ');
        return Redirect::to('/all_manufacture');
    }
    public function unactive_manufacture($manufacture_id)
    {
        DB::table('tb1_manufacture')->where('manufacture_id',$manufacture_id)->update(['publication_status' => 0]);
    ...
    {
        DB::table('tb1_manufacture')->where('manufacture_id',$manufacture_id)->update(['publication_status' => 1]);
    ...
    public function update_manufacture($manufacture_id,Request $request)
    {
        ...
        DB::table('tb1_manufacture') -> where('manufacture_id',$manufacture_id)->update($data);
    ...
    {
        $this->AdminAuthCheck();
        $manufacture_info= DB::table('tb1_manufacture')->where('manufacture_id',$manufacture_id)->first();
